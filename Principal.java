...
public class Principal extends JFrame implements ActionListener{
  ...
  public Principal(){
   ...
   menuOpciones.setForeground(new Color(255,0,0));
   mb.add(menuOpciones);

   menuCalcular = new JMenu("Calcular");
   menuCalcular.setBackground(new Color(255,255,255));
   menuCalcular.setFont(new Font("Andale Mono", 1, 14));
   menuCalcular.setForeground(new Color(255,0,0));
   mb.add(menuCalcular);
   ...
   miCreador.setForeground(new Color(0,0,0));
   ...
   labelLogo.setBounds(5,5,300,220);
   add(labelLogo);
   ...
   labelTitle.setBounds(45,140,300,50);
   ...
   labelfooter = new JLabel("©2019 Amcor Flexibles Santiago Norte Todos los derechos reservados");
  ...
  public void actionPerformed(ActionEvent e){
   if(e.getSource() == miCalculo){
     ...
     if(nombreTrabajador.equals("") || AP.equals("") || AM.equals("") ||
       ...
       if(Departamento.equals("Atencion al cliente")){
         ...
         if(Antiguedad.equals("1 años de servicio")){
   ...
   if(e.getSource() == miCreador){
     ...
     JOptionPane.showMessageDialog(null,"Desarrollado por Roger Parada\n"+
                                         "       merwebotoito amawebo");
   }
 }
